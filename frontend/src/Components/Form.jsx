    ...
    <div className="flex items-center justify-center min-h-screen  font-serif bg-gray-100 pt-5 pb-6 ">
      ...
      <p className="text-lg">Have Questions? We’d Love to Hear from You!</p>
        ...
        <form className="grid gap-5" onSubmit={handleSubmit}>
         ...
         <button type="submit" className="w-full py-2 px-4 text-lg font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:ring-2 focus:ring-blue-300 focus:outline-none">Send Message </button>
        </form>
        <hr className="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
