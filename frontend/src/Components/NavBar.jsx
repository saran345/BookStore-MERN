...
export default function NavBar() {
  return (
    <>
     <div className=' mx-auto w-screen  p-0 m-0 overflow-auto '>
    <nav  className="flex flex-shrink w-screen  px-10   py-4 bg-blue-600  ">
        <div className="flex flex-wrap p-3 w-full items-center justify-between text-blue-gray-900">
        <div className="mr-4 text-2xl  lg:pl-16 cursor-pointer py-1.5 font-medium text-white">Logo</div>
       ...
       <div className='flex items-center gap-4 rounded-lg sm:pl-16 py-1.5'>
       <Link to="/login" >
